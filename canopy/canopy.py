...
class Canopy:
    ...
    def __init__(self, config_path):
        ...
        self.phyregs_area_sqkm_field = str.strip(conf.get('config', 'phyregs_area_sqkm_field'))
        self.naipqq_layer = str.strip(conf.get('config', 'naipqq_layer'))
        self.naipqq_phyregs_field = str.strip(conf.get('config', 'naipqq_phyregs_field'))
    ...
    def generate_gtpoints(self, phyreg_ids, min_area_sqkm, max_area_sqkm, min_points,
                          max_points):
        '''
